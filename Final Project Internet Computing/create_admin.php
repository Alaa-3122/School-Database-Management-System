...
<?php
$message = "";
if(isset($_POST['submit']) && $_POST['submit'] == "Create Admin"){
...
<body>
    ...
    <?= $message; ?>
            ...
            <form action="create_admin.php" method="POST" id="signInForm" onsubmit="return CheckForm()">
                ...
                <input type="submit" name="submit" value="Create Admin" class="submit-btn">
            </form>
        </div>
    </div>
</body>
